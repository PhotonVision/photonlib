...
public class SimVisionSystem {
     ...
     * @param robotPoseMeters current pose of the robot on the field. Will be used to calcualte which targets are actually in view, where they are at relative to the robot, and relevant PhotonVision parameters.
     */
    public void processFrame(Pose2d robotPoseMeters){
        ...
        tgtList.forEach((tgt) -> {
            ...
            double distVerticalMeters = tgt.targetHeightAboveGroundMeters - this.cameraHeightOffGroundMeters;
