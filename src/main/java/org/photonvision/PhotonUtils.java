...
public final class PhotonUtils {
   ...
   * robot pose is not required. Note that this method requires the camera to have
   * 0 roll (not be skewed clockwise or CCW relative to the floor), and for there
   * to exist a height differential between goal and camera. The larger this
   ...
   *                           meters. This should be the height of whatever is
   *                           being targeted (i.e. if the targeting region is set
   *                           to top, this should be the height of the top of the
   *                           target).
   ...
   */
  public static Translation2d estimateTargetTranslation(double targetDistanceMeters, Rotation2d yaw) {
   ...
   *                           this would be Transform2d(3 inches, 0 inches, 0
   *                           degrees).
   * @return The position of the robot in the field.
   */
  public static Pose2d estimateFieldToRobot(double cameraHeightMeters, double targetHeightMeters,
    ...
    return PhotonUtils.estimateFieldToRobot(
        PhotonUtils.estimateCameraToTarget(
            PhotonUtils.estimateTargetTranslation(PhotonUtils.calculateDistanceToTargetMeters(cameraHeightMeters,
  ...
  /**
   * Estimates a {@link Transform2d} that maps the camera position to the target
   * position, using the robot's gyro. Note that the gyro angle provided *must*
   * line up with the field coordinate system -- that is, it should read zero
   * degrees when pointed towards the opposing alliance station, and increase as
   * the robot rotates CCW.
   *
   * @param cameraToTargetTranslation A Translation2d that encodes the x/y
   *                                  position of the target relative to the
   *                                  camera.
   * @param fieldToTarget             A Pose2d representing the target position in
   ...
   * @return The position of the robot in the field.
   */
  public static Pose2d estimateFieldToRobot(Transform2d cameraToTarget, Pose2d fieldToTarget,
   ...
   * position of the target relative to the camera, and the target relative to the
   * field. This *only* tracks the position of the camera, not the position of the
   * robot itself.
   *
   * @param cameraToTarget The position of the target relative to the camera.
   * @param fieldToTarget  The position of the target in the field.
